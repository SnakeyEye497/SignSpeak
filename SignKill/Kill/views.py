...
classifier = Classifier('D:\\Past-times\\Zero Budget\\Project\\SignKill\\SignKill\\Model\\keras_model.h5', "D:\\Past-times\\Zero Budget\\Project\\SignKill\\SignKill\\Model\\labels.txt")
...
#     # Logic to get or generate label
...
def save(request):
    if request.method == 'POST':
        ...
        en=models.ContactEnquiry(Name=name,Email=email,Subject=subject,Message=message)
        en.save()
        return redirect('http://127.0.0.1:8000/')  # Change 'index' to the actual URL name for your index page
